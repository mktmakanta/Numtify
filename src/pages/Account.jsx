  ...
  return (
    <section className="font-raleway  bg-white p-5 pb-10 rounded-lg space-y-6 mt-7">
      <div className="space-y-3">
        ...
        />
        <button className="px-6 py-3 font-semibold rounded-sm border border-gray-300 bg-blue-500  hover:bg-blue-600 transition duration-300 text-white">
          Change email
        </button>
      </div>
      <div className="space-y-3">
        ...
        <input
          ...
          value=""
        />
        <button className=" px-3 lg:px-6 py-3 font-semibold rounded-sm border border-gray-300 bg-blue-500  hover:bg-blue-600 transition duration-300 text-white">
          Change Password
        </button>
      </div>
    </section>
